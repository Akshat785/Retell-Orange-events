...
/// <summary>
/// Model representing a request to create a new lead in the CRM sheet.
/// </summary>
public class CreateLeadRequest
{
    ...
    private decimal? _customerBudget;
    ...
    [JsonPropertyName("customer_budget")]
    public decimal? CustomerBudgetSnake 
    { 
        get => _customerBudget; 
        set => _customerBudget = value; 
    }
